    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F0F3FB] dark:bg-background-dark transition-colors duration-300">
      ...
      <div className="w-full max-w-md p-8 space-y-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="rounded-md space-y-4">
            ...
            <div className="relative">
              ...
              >
                {showConfirmPassword ? <EyeOff className="h-5 w-5 text-gray-400 dark:text-text-muted-dark" /> : <Eye className="h-5 w-5 text-gray-400 dark:text-text-muted-dark" />}
              </button>
            </div>
          </div>
          ...
          <div className="pt-2 space-y-3">
            <button
              type="submit"
              disabled={loading}
              className="group relative flex w-full justify-center rounded-lg border border-transparent bg-black dark:bg-white py-3 px-4 text-sm font-medium text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-white/40 focus:ring-offset-2 disabled:bg-gray-500 dark:disabled:bg-gray-600 transition-colors"
            >
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-text-muted-dark">
          ...
          <Link href="/login" className="font-medium text-gray-900 dark:text-text-main-dark hover:text-gray-700 dark:hover:text-white underline">
            Log in
          </Link>
        </p>
      </div>
